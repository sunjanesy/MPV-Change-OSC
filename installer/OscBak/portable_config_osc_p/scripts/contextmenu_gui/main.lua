...
-- 二级菜单 —— 加载
    open_menu = {
        {COMMAND, "打开文件", "", "script-binding load_plus/import_files", "", false},
        {COMMAND, "粘贴网址", "", "script-binding input_plus/load_cbd", "", false},
    },
...
-- 二级菜单 —— 其它
    etc_menu = {
        {COMMAND, "状态信息（开/关）", "", "script-binding display-stats-toggle", "", false},
        {COMMAND, "状态信息-概览", "", "script-binding display-page-1", "", false},
        {COMMAND, "状态信息-帧计时（可翻页）", "", "script-binding display-page-2", "", false},
        {COMMAND, "状态信息-输入缓存", "", "script-binding display-page-3", "", false},
        {COMMAND, "状态信息-快捷键（可翻页）", "", "script-binding display-page-4", "", false},
        {COMMAND, "状态信息-内部流（可翻页）", "", "script-binding display-page-0", "", false},
        {COMMAND, "控制台", "", "script-binding console/enable", "", false},
    },
...
-- 二级菜单 —— 加载
        open_menu = {
            {COMMAND, "打开文件", "", "script-binding load_plus/import_files", "", false},
            {COMMAND, "粘贴网址", "", "script-binding input_plus/load_cbd", "", false},
            {COMMAND, "追加地址到播放列表", "", "script-binding input_plus/load_cbd_add", "", false},
            {COMMAND, "追加音轨", "", "script-binding load_plus/append_aid", "", false},
            {COMMAND, "追加字幕轨", "", "script-binding load_plus/append_sid", "", false},
            {COMMAND, "指定次字幕（滤镜）", "", "script-binding load_plus/append_vfSub", "", false},
            {COMMAND, "显示/隐藏次字幕（滤镜）", "", "script-binding load_plus/toggle_vfSub", "", false},
            {COMMAND, "移除次字幕（滤镜）", "", "script-binding load_plus/remove_vfSub", "", false},
            {SEP},
...
-- 二级菜单 —— 导航
        navi_menu = {
            {COMMAND, "OSD高级播放列表", "", "script-binding playlist_osd/display", "", false},
